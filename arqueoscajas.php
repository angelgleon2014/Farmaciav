...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Arqueos de Cajas<span class="pull-right">
...
<li><a href="reportepdf?codsucursal=<?php echo base64_encode($_SESSION["codsucursal"]); ?>&tipo=<?php echo base64_encode("ARQUEOSGENERAL") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Pdf)"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reporteexcel?codsucursal=<?php echo base64_encode($_SESSION["codsucursal"]); ?>&tipo=<?php echo base64_encode("ARQUEOSGENERAL") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Excel)"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span></h3>
</div>
...
<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;" width="100%" cellspacing="0">
                         ...
                         <tr role="row">
                          ...
                          <th>Estimado</th>
                          <th>Dinero en cr&eacute;dito</th>
                          <th>Real</th>
                          <th>Diferencia</th>
                         <th>Acciones</th>
                         </tr>
...
<td><?php echo number_format($reg[$i]['montoinicial'] + $reg[$i]['ingresos'] - $reg[$i]['egresos'], 2, '.', ','); ?></td>
                                               <td><?php echo $reg[$i]['dineroencredito']; ?></td>
