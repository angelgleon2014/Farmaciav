...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Arqueos por Fechas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="arqueoscajas">Control</a></li>
<li class="active">Arqueos por Fechas</li>
</ol>
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Arqueos por Fechas</h3></div>
...
<button type="button" onClick="BuscaArqueosFechas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>      
                          </div>
