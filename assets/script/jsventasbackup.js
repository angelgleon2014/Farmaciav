...
function round(value, exp) {
  ...
  $(document).ready(function() {
        ...
        function AgregaVenta () {
            ...
            //modificado
          /*if (($('#stocktotal').val() / cantidadprev) < 1) {
                  $("#cantidad2").focus();
              ...
              //comentado
                ...
                totalPrecio = precioPrev;
                  ...
                  Carrito.Cantidad2 = $('input#cantidad').val() - 1;
  ...
  function addItem(codigo, cantidad, producto, presentacion, principioactivo, descripcion, tipo, cantidad2, precio, precio2, precio3, descproducto, desclaboratorio, descgeneral, ivaproducto, precioconiva, opCantidad,tipoventa=", ", precioventablisterdesc, precioventacajadesc) {
      var Carrito = new Object();
