...
function CargaProductos(codalmacen, codproducto, producto, principioactivo, descripcion, codpresentacion, codmedida, preciocompra, precioventacaja, precioventaunidad, stockcajas, unidades, stockunidad, stocktotal, stockminimo, ivaproducto, descproducto, fechaelaboracion, fechaexpiracion, codigobarra, codlaboratorio, codproveedor, codsucursal, loteproducto, ubicacion, statusp, busqueda = "", precioventablister = 0, blisterunidad = 0, stockblister = 0, preciocompraunidad = 0, preciocomprablister = 0, registrosanitario = "") {
  ...
  $("#updateproducto #preciocompra").val(preciocompra);
  ...
  $("#updateproducto #stockblister2").val(stockblister);

  $("#updateproducto #preciocomprablister").val(preciocomprablister);
  $("#updateproducto #preciocompraunidad").val(preciocompraunidad);

  $("#updateproducto #rsanitario").val(registrosanitario);
}
...
function CargaDetalleVenta(coddetalleventa, tipodocumento, codigoventa, codsucursal, ivave, codproducto, producto, principioactivo, descripcion,
  nommedida, nompresentacion, preciocomprav, precioventacajav, precioventaunidadv, preciounitario, cantventa, cantbonificv, valortotalv, descproductov, descporc, descbonificv, valornetov, baseimponible, ivaproductov, fechadetalleventa, tipobusquedad, codcaja, fecha) {
  // aqui asigno cada valor a los campos correspondientes
  ...
  $("#updatedetallesventas #nompresentacion").val(nompresentacion);
...
function calcularCantidades(type) {
  ...
  if (type == 1) {
    ...
    var stockblister = $('input#stockblister').val();
    ...
    //$("#totalBlister").val((stockcajas == "0") ? "0" : Math.round(stockcajas * stockblister) );
    $("#totalBlister").val(($("#stocktotal").val() == "0") ? "0" : Math.floor($("#stocktotal").val() / unidadblister));
    ...
    //$("#totalBlister2").val((stockcajas == "0") ? "0" : Math.round(stockcajas * stockblister ));
    $("#totalBlister2").val(($("#stocktotal2").val() == "0") ? "0" : Math.floor($("#stocktotal2").val() / unidadblister));
