...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Bancos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Bancos</li>
</ol>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Bancos<span class="pull-right"><a href="forbanco" class="btn btn-default waves-effect waves-light" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Entidad Bancaria"><span class="fa fa-plus"></span> Nuevo</a></span></h3>
</div>
                ...
                if(isset($_GET["mesage"])) {
                    switch($_GET["mesage"]) {
                        case 1:
                            ...
                            echo "<span class='fa fa-check-square-o'></span> LA ENTIDAD BANCARIA FUE ELIMINADA EXITOSAMENTE</center>";
                            echo "</div>";
                            break;
                        ...
                        case 2:
                            ...
                            echo "<center><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<span class='fa fa-info-circle'></span> ESTA LA ENTIDAD BANCARIA NO PUEDE SER ELIMINADA, TIENE TARJETAS ASOCIADAS ACTUALMENTE</center>";
                            echo "</div>";
                            break;
                        ...
                        case 3:
                            ...
                            echo "<center><span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR ENTIDADES BANCARIAS, NO ERES EL ADMINISTRADOR DEL SISTEMA </center>";
                            echo "</div>";
                            break;
...
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Entidad Bancaria" onClick="actualizar('forbanco?codbanco=<?php echo base64_encode($reg[$i]["codbanco"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Entidad Bancaria" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codbanco=<?php echo base64_encode($reg[$i]["codbanco"]) ?>&tipo=<?php echo base64_encode("BANCOS") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php }
    } ?>
											   </tbody>
