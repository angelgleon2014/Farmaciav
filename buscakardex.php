     ...
     <div class="col-md-6"> 
      ...
      <div class="col-md-6"> 
       <div class="form-group has-feedback"> 
        ...
        <input class="form-control" type="text" name="busquedaproductoc" id="busquedaproductoc" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Realice la b&uacute;squeda de Productos" required="required">
...
<input type="hidden" name="codsucursal" id="codsucursal" value="<?php echo $_SESSION["codsucursal"]; ?>">
      ...
      <div class="col-md-12"> 
       <div class="form-group has-feedback"> 
        <label class="control-label">Búsqueda de Productos: <span class="symbol required"></span></label>
        <input type="hidden" class="form-control" name="codproducto" id="codproducto">
        <input class="form-control" type="text" name="busquedaproductov" id="busquedaproductov" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Realice la b&uacute;squeda de Productos" required="required">
        <i class="fa fa-search form-control-feedback"></i>  
      </div> 
    </div>  
  </div><br>
