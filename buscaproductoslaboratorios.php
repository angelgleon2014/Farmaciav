...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Productos por Laboratorios</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="productos">Control</a></li>
<li class="active">Productos por Laboratorios</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="buscaproductoslaboratorio" id="buscaproductoslaboratorio">
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Productos por Laboratorios</h3></div>
...
<?php if($_SESSION['acceso'] == "administradorG") { ?>
   ...
   <div class="row">
    ...
    for($i = 0;$i < sizeof($suc);$i++) {
        ?>
            ...
            <?php } ?>
                    ...
                    <div class="col-md-6"> 
       <div class="form-group has-feedback"> 
        <label class="control-label">Seleccione Laboratorio: </label>
        <select name="codlaboratorio" id="codlaboratorio" class="form-control" tabindex="13">
          <option value="">SELECCIONE</option>
          <?php
          $lab = new Login();
    ...
    for($i = 0;$i < sizeof($lab);$i++) {
        ?>
            <option value="<?php echo base64_encode($lab[$i]['codlaboratorio']); ?>"><?php echo $lab[$i]['nomlaboratorio'] ?></option>        
            <?php } ?>
          </select>  
        </div> 
      </div> </div><br>
...
<button type="button" onClick="BuscaProductosLaboratorios()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
						        ...
						        <div id="muestraproductoslaboratorios"></div>
						          </form>
           </div>
       </div>
</div>
