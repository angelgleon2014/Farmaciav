...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Búsqueda de Traspasos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="traspasos">Control</a></li>
<li class="active">Búsqueda de Traspasos</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
    <form class="form" method="post"  action="#" name="buscartraspasos" id="buscartraspasos">
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Búsqueda de Trapasos</h3></div>
  ...
  <div class="row">
     <div class="col-md-3"> 
      <div class="form-group has-feedback"> 
        ...
        <select name="envio" id="envio" class="form-control" onChange="CargaSucursales(this.form.envio.value);" required="" aria-required="true">
          <option value="">SELECCIONE</option>
          <?php
                  $suc = new Login();
    $suc = $suc->ListarSucursal();
    for($i = 0;$i < sizeof($suc);$i++) {
        ?>
            <option value="<?php echo base64_encode($suc[$i]['codsucursal']); ?>"><?php echo $suc[$i]['razonsocial']; ?></option>       
            <?php } ?>
          </select>
        </div> 
      </div>
...
<input class="form-control" type="text" name="desde" id="desde" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha de Inicio" required="" aria-required="true">
...
<input class="form-control" type="text" name="hasta" id="hasta" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha Final" required="" aria-required="true">
                        <i class="fa fa-calendar form-control-feedback"></i> 
                              </div> 
                        </div>  
                    </div><br>
...
<?php } else { ?>
  ...
  <div class="col-md-3"> 
                <div class="form-group has-feedback"> 
    <label class="control-label">Sucursal de Emisión: <span class="symbol required"></span></label> 
  <input type="hidden" name="envio" id="envio" value="<?php echo base64_encode($_SESSION["codsucursal"]); ?>">
...
<button type="button" onClick="BuscaTraspasos()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>      
                          </div>
                    ...
                    <div id="muestratraspasosproductos"></div>
                      </form>
           </div>
       </div>
</div>
