...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Productos en Stock Minimo</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="productos">Control</a></li>
<li class="active">Productos en Stock Minimo</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="buscaproductosstock" id="buscaproductosstock">
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Productos en Stock Minimo</h3></div>
...
<button type="button" onClick="BuscaProductosStock()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
						        ...
						        <div id="muestraproductosstock"></div>
						          </form>
           </div>
       </div>
</div>
