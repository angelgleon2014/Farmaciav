...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Carga Masiva de Productos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="cargamasiva">Control</a></li>
<li class="active">Carga Masiva de Productos</li>
</ol>
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Carga Masiva de Productos</h3></div>
...
<div class="col-sm-12 col-xs-12"> 
		...
		<form class="form" method="post"  action="#" name="cargarproductos" id="cargarproductos" enctype="multipart/form-data">
...
<small><p>Para realizar la Carga masiva de Productos el archivo debe de ser extensión (CSV Delimitado por Comas). <br></small>
                              </div> 
                        </div>
...
<button type="submit" name="btn-cargar" id="btn-cargar" class="btn btn-primary"><span class="fa fa-cloud-upload"></span> Cargar Productos</button>			
