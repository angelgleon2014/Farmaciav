              ...
              <div class="panel panel-color panel-primary">
                ...
                <form class="form" name="clientes" id="clientes" method="post" action="#">
                  <div class="panel-body">
                    ...
                    <label class="control-label">DNI/RUC de Cliente: <span class="symbol required"></span></label>
<input type="text" class="form-control" name="cedcliente" id="cedcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese DNI/RUC de Cliente" tabindex="1" required="" aria-required="true">
...
<textarea name="direccliente" class="form-control" id="direccliente" onKeyUp="this.value=this.value.toUpperCase();" tabindex="3" autocomplete="off" placeholder="Ingrese Dirección de Cliente" aria-required="true"></textarea>
...
<input type="text" class="form-control" name="celcliente" id="celcliente" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese N° de Celular de Cliente" tabindex="6"  aria-required="true">
                                                ...
                                                <div class="row" style="display:none">
                                                      ...
                                                      <div class="col-md-12">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <input class="form-control" type="text" name="buscacliente" id="buscacliente" onKeyUp="this.value=this.value.toUpperCase(); BuscarClientes();" autocomplete="off" placeholder="Ingrese Código, Ruc/Dni o Nombre para Búsqueda de Clientes" required="required">
                                                                            ...
                                                                            for($i = 0;$i < sizeof($clientes);$i++) {
                                                                                ?>
                                                                                                <tr role="row" class="odd">
                                                                                                            ...
                                                                                                            <td><?php echo $clientes[$i]['nrocliente']; ?></td>
                                                                                                            <td><?php echo $clientes[$i]['cedcliente']; ?></td>
                                                                                                            <td><?php echo $clientes[$i]['nomcliente']; ?></td>
                                                                                                            <td><?php echo $clientes[$i]['direccliente']; ?></td>
                                                                                                            <td><?php echo $clientes[$i]['tlfcliente']; ?></td>
                                                                                                            <td><?php echo $clientes[$i]['emailcliente']; ?></td>
                                                                                                            <td>
                                                                
                                                                                                              <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerCliente('<?php echo base64_encode($clientes[$i]["codcliente"]); ?>')"><i class="fa fa-search-plus"></i></a>

                                                                                                              <a href="#" class="btn btn-primary btn-xs" title="Editar" data-toggle="modal" data-target="#myModal2" data-backdrop="static" data-keyboard="false" onClick="CargaCampos('<?php echo $clientes[$i]["codcliente"]; ?>','<?php echo $clientes[$i]["cedcliente"]; ?>','<?php echo $clientes[$i]["nomcliente"]; ?>','<?php echo $clientes[$i]["direccliente"]; ?>','<?php echo $clientes[$i]["tlfcliente"]; ?>','<?php echo $clientes[$i]["celcliente"]; ?>','<?php echo $clientes[$i]["emailcliente"]; ?>')"><i class="fa fa-pencil"></i></a>
                                 
                                                                                                              <a class="btn btn-danger btn-xs" title="Eliminar" onClick="EliminarCliente('<?php echo base64_encode($clientes[$i]["codcliente"]); ?>','<?php echo base64_encode("CLIENTES") ?>')"><i class="fa fa-trash-o"></i></a> 
                                                                                                            </td>
                                                                                                  </tr>
                                                                <?php }
                                                                            }
