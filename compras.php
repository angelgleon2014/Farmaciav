...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Compras</h3>
</div>
...
<?php if($_SESSION['acceso'] == "administradorG") { ?><td><?php echo $reg[$i]['razonsocial']; ?></td><?php } ?>
                  ...
                  <td><?php echo $reg[$i]['articulos']; ?></td>
											   <td>
<a href="#" class="btn btn-success btn-xs" onClick="VerCompra('<?php echo base64_encode($reg[$i]['codcompra']) ?>')" data-href="#" data-toggle="modal" data-target=".bs-example-modal-lg" data-placement="left" data-backdrop="static" data-keyboard="false" data-id="" rel="tooltip" title="Ver Compra"><i class="fa fa-search-plus"></i></a>

<a href="reportepdf?codcompra=<?php echo base64_encode($reg[$i]['codcompra']); ?>&tipo=<?php echo base64_encode("FACTURACOMPRAS") ?>" target="_black" rel="noopener noreferrer" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Factura de Compra"><i class="fa fa-print"></i></a></td>
											   </tr>
											   <?php }
            } ?>
											   </tbody>
