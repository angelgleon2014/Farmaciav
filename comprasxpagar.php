...
<div class="row">
<div class="col-sm-12">
		<form class="form" method="post"  action="#" name="buscacomprasxpagar" id="buscacomprasxpagar">
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Cuentas por Pagar</h3></div>
...
<button type="button" onClick="BuscaComprasxPagar()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
						        ...
						        <div id="muestracompraxpagar"></div>
						          </form>
           </div>
       </div>
</div>
