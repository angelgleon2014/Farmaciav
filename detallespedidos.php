...
<!-- Modal para mostrar detalles de pedido de producto-->
<div id="panel-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
 ...
 <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
             <h3 class="panel-title"><i class="fa fa-align-justify"></i> Detalle de Pedido</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestradetallepedidomodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control Detalle de Pedidos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control Detalle de Pedidos</li>
</ol>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Detalles Pedidos</h3>
</div>
                ...
                if(isset($_GET["mesage"])) {
                    switch($_GET["mesage"]) {
                        case 1:
                            ...
                            echo "<center><span class='fa fa-check-square-o'></span> EL PRODUCTO FUE ELIMINADO EXITOSAMENTE DEL PEDIDO</center>";
                            echo "</div>";
                            break;
                        ...
                        case 2:
                            ...
                            echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<center><span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR PRODUCTOS EN PEDIDOS, NO ERES EL ADMINISTRADOR DEL SISTEMA</center>";
                            echo "</div>";
                            break;
    ...
    for($i = 0;$i < sizeof($reg);$i++) {
        ...
        ?>
                         ...
                         <td><?php echo $reg[$i]['cantpedido']; ?></td>
											   <td>
<a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Detalle Pedido" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerDetallePedido('<?php echo base64_encode($reg[$i]["coddetallepedido"]); ?>')"><i class="fa fa-search-plus"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Detalle Pedido" onClick="eliminardp('eliminar?<?php echo base64_encode('eliminar'); ?>&coddetallepedido=<?php echo base64_encode($reg[$i]["coddetallepedido"]) ?>&codpedido=<?php echo base64_encode($reg[$i]["codpedido"]) ?>&tipo=<?php echo base64_encode("DETALLEPEDIDO") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php }
    } ?>
											   </tbody>
