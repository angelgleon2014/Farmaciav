...
if(isset($_SESSION['acceso'])) {
    if ($_SESSION['acceso'] == "administradorG" || $_SESSION["acceso"] == "administradorS") {
        ...
        if(isset($_POST['btn-submit'])) {
            $reg = $tra->RegistrarBancos();
            exit;
        } elseif(isset($_POST['btn-update'])) {
            $reg = $tra->ActualizarBancos();
            exit;
        }
        ?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Bancos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="bancos">Control</a></li>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Bancos</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
			
<?php  if (isset($_GET['codbanco'])) {

    $reg = $tra->BancosPorId(); ?>
			
      <form class="form" name="updatebanco" id="updatebanco" method="post" data-id="<?php echo $reg[0]["codbanco"] ?>" action="#">
				
		<?php } else { ?>
				
		<form class="form" method="post"  action="#" name="bancos" id="bancos">	
...
<input type="hidden" name="codbanco" id="codbanco" <?php if (isset($reg[0]['codbanco'])) { ?> value="<?php echo $reg[0]['codbanco']; ?>"<?php } ?>>
  <input type="text" class="form-control" name="nombanco" id="nombanco" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Banco" <?php if (isset($reg[0]['nombanco'])) { ?> value="<?php echo $reg[0]['nombanco']; ?>"<?php } ?> tabindex="1" required="" aria-required="true">
