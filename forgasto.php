                                ...
                                <div class="col-sm-12">
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Gastos
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <form method="post" action="#" name="formgastos" id="formgastos">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="descripcion" id="descripcion" class="form-control" placeholder="Descripción del gasto" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="monto_total" id="monto_total" class="form-control" placeholder="0.00" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" name="fecha_gasto" id="fecha_gasto" class="form-control" required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="tipo_gasto" id="tipo_gasto" class="form-control" placeholder="Ej. Servicios, Insumos..." required>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <?php if ($_SESSION['acceso'] == "administradorS") { ?>
                                                                            <input type="hidden" name="codsucursal" value="<?php echo $_SESSION["codsucursal"]; ?>">
                                                                        ...
                                                                        <?php } else { ?>
                                                                            <select name="codsucursal" id="codsucursal" class="form-control" required>
                                                                                ...
                                                                                foreach ($sucursal as $s) {
                                                                                    echo "<option value='{$s['codsucursal']}'>{$s['razonsocial']}</option>";
                                                                                }
                                                                                ?>
                                                                            </select>
                                                                        <?php } ?>
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="submit" name="btn-submit" class="btn btn-primary"><i class="fa fa-save"></i> Guardar Gasto</button>
