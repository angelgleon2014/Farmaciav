...
if(isset($_SESSION['acceso'])) {
    if ($_SESSION['acceso'] == "administradorG" || $_SESSION["acceso"] == "administradorS") {
        ...
        if(isset($_POST['btn-submit'])) {
            $reg = $tra->RegistrarMedidas();
            exit;
        } elseif(isset($_POST['btn-update'])) {
            $reg = $tra->ActualizarMedidas();
            exit;
        }
        ?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Categorías</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="medidas">Control</a></li>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Catehorías</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
			
<?php  if (isset($_GET['codmedida'])) {

    $reg = $tra->MedidasPorId(); ?>
			
<form class="form" name="updatemedida" id="updatemedida" method="post" data-id="<?php echo $reg[0]["codmedida"] ?>" action="#">
				
		<?php } else { ?>
				
<form class="form" method="post"  action="#" name="medidas" id="medidas">	
		...
		<?php } ?>
				...
				<div class="row"> 
                        ...
                        <label class="control-label">Nombre de la Categoría: <span class="symbol required"></span></label>
<input type="hidden" name="codmedida" id="codmedida" <?php if (isset($reg[0]['codmedida'])) { ?> value="<?php echo $reg[0]['codmedida']; ?>"<?php } ?>>
  <input type="text" class="form-control" name="nommedida" id="nommedida" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de la Categoría" <?php if (isset($reg[0]['nommedida'])) { ?> value="<?php echo $reg[0]['nommedida']; ?>"<?php } ?> tabindex="1" required="" aria-required="true">
