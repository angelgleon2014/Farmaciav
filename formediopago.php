...
<input type="hidden" name="codmediopago" id="codmediopago" <?php if (isset($reg[0]['codmediopago'])) { ?> value="<?php echo $reg[0]['codmediopago']; ?>"<?php } ?>>
  <input type="text" class="form-control" name="mediopago" id="mediopago" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Medio de Pago" <?php if (isset($reg[0]['mediopago'])) { ?> value="<?php echo $reg[0]['mediopago']; ?>"<?php } ?> tabindex="1" required="" aria-required="true">
