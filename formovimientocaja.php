...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Mov. Cajas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="movimientoscajas">Control</a></li>
<li class="active">Mov. Cajas</li>
</ol>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Mov. Cajas</h3></div>
...
<select name="mediopagomovimientocaja" id="mediopagomovimientocaja" class="form-control" required="" aria-required="true">
      ...
      $medio = new Login();
                        ...
                        for($i = 0;$i < sizeof($medio);$i++) {
                            ?>
  <option value="<?php echo $medio[$i]['codmediopago']; ?>"<?php if (!(strcmp($reg[0]['mediopagomovimientocaja'], htmlentities($medio[$i]['codmediopago'])))) {
      echo "selected=\"selected\"";
  } ?>><?php echo $medio[$i]['mediopago']; ?></option>        
                      <?php } ?>
                  </select>
                             <?php } else { ?>  
               <select name="mediopagomovimientocaja" id="mediopagomovimientocaja" class="form-control" required="" aria-required="true">
