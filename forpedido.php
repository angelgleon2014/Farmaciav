...
<div class="row">
                <form class="form" method="post"  action="#" name="pedidos" id="pedidos">
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Pedidos</h3>
                                    </div>
...
<div class="row">
     ...
     <div class="col-md-3"> 
       <div class="form-group has-feedback"> 
         ...
         <div id="codigopedido"><input class="form-control" type="text" name="codpedido" id="codpedido" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Codigo Pedido" value="<?php echo $reg = $tra->CodigoPedidos(); ?>" tabindex="1" readonly="readonly"></div>
      ...
      <div class="col-md-3"> 
       <div class="form-group has-feedback"> 
         ...
         <select name="codproveedor" id="codproveedor" class="form-control" tabindex="2" required="" aria-required="true">
      ...
      <?php if ($_SESSION['acceso'] == "administradorS") { ?>
       ...
       <div class="col-md-3"> 
         <div class="form-group has-feedback"> 
          ...
          <input type="text" class="form-control" name="sucursal" id="sucursal" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $_SESSION["razonsocial"]; ?>" tabindex="3" readonly="readonly">
      ...
      <?php } else { ?>
       ...
       <div class="col-md-3"> 
         <div class="form-group has-feedback"> 
           ...
           <select name="codsucursal" id="codsucursal" class="form-control" tabindex="3" required="" aria-required="true">
            <option value="">SELECCIONE</option>
            <?php
            $sucursal = new Login();
...
<input class="form-control" type="text" name="fecharegistro" id="fecharegistro" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Fecha Pedido" tabindex="4" date="" readonly="readonly">
  <i class="fa fa-calendar form-control-feedback"></i>
    ...
    <div class="row">
      ...
      <div class="col-md-4"> 
       <div class="form-group has-feedback"> 
        ...
        <input type="text" class="form-control agregap" name="busquedaproductoc" id="busquedaproductoc" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" tabindex="5" placeholder="Búsqueda de Productos Existentes">
    ...
    <div class="col-md-2"> 
      <div class="form-group has-feedback"> 
        ...
        <input type="text" class="form-control agregap" name="codproducto" id="codproducto" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" tabindex="6" placeholder="Ingrese Código">
    ...
    <div class="col-md-3"> 
     <div class="form-group has-feedback"> 
      ...
      <input type="text" class="form-control agregap" name="producto" id="producto" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" tabindex="7" placeholder="Ingrese Nombre">                        
      <i class="fa fa-pencil form-control-feedback"></i> 
    </div> 
  </div>
  ...
  <div class="col-md-3"> 
   <div class="form-group has-feedback"> 
    ...
    <input type="text" class="form-control agregap" name="principioactivo" id="principioactivo" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" tabindex="8" placeholder="Ingrese Principio Activo">
    <i class="fa fa-pencil form-control-feedback"></i> 
  </div> 
</div>
</div>
...
<div class="col-md-3"> 
 <div class="form-group has-feedback"> 
   ...
   <input type="text" class="form-control agregap" name="descripcion" id="descripcion" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" tabindex="9" placeholder="Ingrese Descripción">
   <i class="fa fa-pencil form-control-feedback"></i> 
 </div> 
</div> 
...
<div id="cargainputpresentacion"><input type="hidden" name="presentacion" id="presentacion"></div>
<select name="codpresentacion" id="codpresentacion" tabindex="10" class="form-control agregap" onchange="CargaPresentacion(this.form.codpresentacion.value);">
                        <option value="">SELECCIONE</option>
      <?php
      $pre = new Login();
...
<div id="cargainputmedida"><input type="hidden" name="medida" id="medida"></div>
<select name="codmedida" id="codmedida" tabindex="11" class="form-control agregap" onchange="CargaMedida(this.form.codmedida.value);">
                        <option value="">SELECCIONE</option>
      <?php
      $med = new Login();
...
<option value="<?php echo $med[$i]['codmedida'] ?>"><?php echo $med[$i]['nommedida'] ?></option>        
      ...
      <div class="col-md-2"> 
        <div class="form-group has-feedback"> 
          ...
          <input type="text" class="form-control agregap" name="cantidad" id="cantidad" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" tabindex="12" placeholder="Ingrese Principio Activo" value="1">
          <i class="fa fa-pencil form-control-feedback"></i> 
        </div> 
      </div>
     ...
     <div class="col-md-3"> 
       <div class="form-group has-feedback"> 
        ...
        <select name="codlaboratorio" id="codlaboratorio" class="form-control agregap" tabindex="13">
          <option value="">SELECCIONE</option>
          <?php
          $lab = new Login();
...
<div align="right">
  <button type="button" id="AgregaP" tabindex="14" class="btn btn-info"><span class="fa fa-cart-plus"></span> Agregar</button> 
</div>
<hr>
  ...
  <table id="carrito" class="table table-small-font table-striped">
    <thead>
      <tr style="background:#FFCC66;font-size:14px;">
        ...
        <th style="color:#FFFFFF;"><div align="center">Código</div></th>
        <th style="color:#FFFFFF;"><div align="center">Nombre de Producto</div></th>
        <th style="color:#FFFFFF;"><div align="center">Principio Activo</div></th>
...
<button type="submit" tabindex="14" name="btn-submit" id="btn-submit" class="btn btn-primary"><span class="fa fa-save"></span> Guardar</button>     
<button class="btn btn-danger" type="button" id="vaciarp"><i class="fa fa-times-circle"></i> Limpiar</button>  
                      </div>
