...
if(isset($_SESSION['acceso'])) {
    if ($_SESSION['acceso'] == "administradorG" || $_SESSION["acceso"] == "administradorS") {
        ...
        if(isset($_POST['btn-submit'])) {
            $reg = $tra->RegistrarPresentacion();
            exit;
        } elseif(isset($_POST['btn-update'])) {
            $reg = $tra->ActualizarPresentacion();
            exit;
        }
        ?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Presentación</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="presentaciones">Control</a></li>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Presentación</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
			
<?php  if (isset($_GET['codpresentacion'])) {

    $reg = $tra->PresentacionPorId(); ?>
			
<form class="form" name="updatepresentacion" id="updatepresentacion" method="post" data-id="<?php echo $reg[0]["codpresentacion"] ?>" action="#">
				
		<?php } else { ?>
				
		<form class="form" method="post"  action="#" name="presentaciones" id="presentaciones">	
...
<input type="hidden" name="codpresentacion" id="codpresentacion" <?php if (isset($reg[0]['codpresentacion'])) { ?> value="<?php echo $reg[0]['codpresentacion']; ?>"<?php } ?>>
  <input type="text" class="form-control" name="nompresentacion" id="nompresentacion" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Presentación" <?php if (isset($reg[0]['nompresentacion'])) { ?> value="<?php echo $reg[0]['nompresentacion']; ?>"<?php } ?> tabindex="1" required="" aria-required="true">
