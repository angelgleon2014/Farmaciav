...
if(isset($_SESSION['acceso'])) {
    if ($_SESSION['acceso'] == "administradorG" || $_SESSION["acceso"] == "administradorS") {
        ...
        if(isset($_POST['btn-submit'])) {
            $reg = $tra->RegistrarTarjetas();
            exit;
        } elseif(isset($_POST['btn-update'])) {
            $reg = $tra->ActualizarTarjetas();
            exit;
        }
        ?>
<!DOCTYPE html>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Gestión de Tarjetas</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="tarjetas">Control</a></li>
<li class="active">Tipos de Tarjetas</li>
</ol>
...
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-edit"></i> Gestión de Tarjetas</h3></div>
<div class="panel-body">
<div class="row">
<div class="col-sm-12 col-xs-12"> 
            <div class="box-body">
			
<?php  if (isset($_GET['codtarjeta'])) {

    $reg = $tra->TarjetasPorId(); ?>
			
      <form class="form" name="updatetarjeta" id="updatetarjeta" method="post" data-id="<?php echo $reg[0]["codtarjeta"] ?>" action="#">
				
		<?php } else { ?>
				
		<form class="form" method="post"  action="#" name="tarjetas" id="tarjetas">	
...
<select name="codbanco" id="codbanco" class="form-control" required="" aria-required="true">
...
<input type="hidden" name="codtarjeta" id="codtarjeta" <?php if (isset($reg[0]['codtarjeta'])) { ?> value="<?php echo $reg[0]['codtarjeta']; ?>"<?php } ?>>
<input type="text" class="form-control" name="nomtarjeta" id="nomtarjeta" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Nombre de Tarjeta" <?php if (isset($reg[0]['nomtarjeta'])) { ?> value="<?php echo $reg[0]['nomtarjeta']; ?>"<?php } ?> required="" aria-required="true">
