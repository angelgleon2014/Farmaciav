...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-star"></i> Control de Gastos</h4>
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-star"></i>Control de Gastos</h3></div>
...
<button type="button" onClick="BuscarGastos()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>       
                           </div>
