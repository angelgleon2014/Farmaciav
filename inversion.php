...
if(isset($_SESSION['acceso'])) {
    if ($_SESSION['acceso'] === "administradorG" || $_SESSION["acceso"] === "administradorS") {
        ...
        /*
         * La suma de ((Precio de Compra Caja  *  Stock Caja) + (Precio de Compra Unidad *  Stock Unidades))
         *
         *
         *
         * */
        ...
        foreach($reg as $r) {
            $sumAcum += (($r['preciocompraunidad'] * $r['stocktotal']));
        }
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Inversion Total</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="configuracion">Administracion</a></li>
<li class="active">Inversion total</li>
</ol>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="panel panel-primary">
                                        <strong>Total Inversion: <?php echo $sumAcum; ?> </strong>
                                    </div>
                                </div>
                            </div>
                        </div>
