...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
    <h3 class="panel-title"><i class="fa fa-align-justify"></i> Detalle de Movimiento</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestradetallekardexmodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Movimientos de Productos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Movimientos de Productos</li>
</ol>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Movimientos de Productos</h3>
</div>
...
<td><abbr title="<?php echo "Nº ".$reg[$i]['codproductom']; ?>"><?php echo $reg[$i]['producto']." ".$reg[$i]['principioactivo']; ?></abbr></td>
<td><?php echo $entradas = ($reg[$i]['entradabonif'] == '0' ? $reg[$i]['entradacaja'] : $reg[$i]['entradacaja']."+".$reg[$i]['entradabonif']); ?></td>
<td><?php echo $salidas = ($reg[$i]['salidabonif'] == '0' ? $reg[$i]['salidaunidad'] : $reg[$i]['salidaunidad']."+".$reg[$i]['salidabonif']); ?></td>
<td><?php echo $devolucion = ($reg[$i]['devolucionbonif'] == '0' ? $reg[$i]['devolucionunidad'] : $reg[$i]['devolucionunidad']."+".$reg[$i]['devolucionbonif']); ?></td>
                        <td><?php echo $reg[$i]['stocktotalunidad']; ?></td>
                        <td><?php echo $reg[$i]['fechakardex']; ?></td>
                         <td>
 
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Detalle Kardex" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerDetalleKardex('<?php echo base64_encode($reg[$i]["codkardex"]); ?>')"><i class="fa fa-search-plus"></i></a> </td>
											   </tr>
											   <?php  }
        } ?>
											   </tbody>
