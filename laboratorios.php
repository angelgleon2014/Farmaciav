...
<div id="panel-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
          ...
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
                                                            <h3 class="panel-title">Datos del Laboratorio</h3> 
                                                        </div> 
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Laboratorios</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Laboratorio</li>
</ol>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Laboratorios<span class="pull-right">
...
<li><a href="forlaboratorio" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Laboratorio"><i class="fa fa-plus"></i> Nuevo</a></li>
<li><a href="reportepdf?tipo=<?php echo base64_encode("LABORATORIOS") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Pdf)"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reporteexcel?tipo=<?php echo base64_encode("LABORATORIOS") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Excel)"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span></h3>
</div>
                ...
                if(isset($_GET["mesage"])) {
                    switch($_GET["mesage"]) {
                        case 1:
                            ...
                            echo "<span class='fa fa-check-square-o'></span> EL LABORATORIO FUE ELIMINADO EXITOSAMENTE</center>";
                            echo "</div>";
                            break;
                        ...
                        case 2:
                            ...
                            echo "<center><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<span class='fa fa-info-circle'></span> ESTE LABORATORIO NO PUEDE SER ELIMINADO, TIENE PRODUCTOS ASOCIADAS ACTUALMENTE</center>";
                            echo "</div>";
                            break;
                        ...
                        case 3:
                            ...
                            echo "<center><span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR LABORATORIOS, NO ERES EL ADMINISTRADOR DEL SISTEMA </center>";
                            echo "</div>";
                            break;
...
<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;" width="100%" cellspacing="0">
												 ...
												 <tbody>
                                                            ...
                                                            <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Laboratorio" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerLaboratorio('<?php echo base64_encode($reg[$i]["codlaboratorio"]); ?>')"><i class="fa fa-search-plus"></i></a>
                                                                                            
                                                            <a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Laboratorio" onClick="actualizar('forlaboratorio?codlaboratorio=<?php echo base64_encode($reg[$i]["codlaboratorio"]) ?>')"><i class="fa fa-pencil"></i></a>
                                                                                            
                                                            <a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Laboratorio" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codlaboratorio=<?php echo base64_encode($reg[$i]["codlaboratorio"]) ?>&tipo=<?php echo base64_encode("LABORATORIOS") ?>')"><i class="fa fa-trash-o"></i></a> </td>
                                                                                                        </tr>
                                                                                                        <?php }
                                                                 } ?>
											    </tbody>
