...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Categorías</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Categorías</li>
</ol>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Categorías<span class="pull-right"><a href="formedida" class="btn btn-default waves-effect waves-light" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Categoría"><span class="fa fa-plus"></span> Nuevo</a></span></h3>
</div>
                ...
                if(isset($_GET["mesage"])) {
                    switch($_GET["mesage"]) {
                        case 1:
                            ...
                            echo "<center><span class='fa fa-check-square-o'></span> LA UNIDAD DE MEDIDA DE PRODUCTO FUE ELIMINADA EXITOSAMENTE </center>";
                            echo "</div>";
                            break;
                        ...
                        case 2:
                            ...
                            echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<center><span class='fa fa-info-circle'></span> ESTA UNIDAD DE MEDIDA NO PUEDE SER ELIMINADA, TIENE PRODUCTOS ASOCIADOS ACTUALMENTE </center>";
                            echo "</div>";
                            break;
...
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Unidad" onClick="actualizar('formedida?codmedida=<?php echo base64_encode($reg[$i]["codmedida"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Unidad" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codmedida=<?php echo base64_encode($reg[$i]["codmedida"]) ?>&tipo=<?php echo base64_encode("MEDIDAS") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php  }
} ?>
											   </tbody>
