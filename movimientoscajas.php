...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Mov. Caja</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Mov. Caja</li>
</ol>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Mov. Caja<span class="pull-right">
...
<li><a href="formovimientocaja" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Movimientos"><i class="fa fa-plus"></i> Nuevo</a></li>
<li><a href="reportepdf?codsucursal=<?php echo base64_encode($_SESSION["codsucursal"]); ?>&tipo=<?php echo base64_encode("MOVIMIENTOSGENERAL") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Pdf)"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reporteexcel?codsucursal=<?php echo base64_encode($_SESSION["codsucursal"]); ?>&tipo=<?php echo base64_encode("MOVIMIENTOSGENERAL") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Excel)"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span></h3>
</div>
