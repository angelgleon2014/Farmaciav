...
<div class="row">
<div class="col-sm-12">
<form class="form" method="post"  action="#" name="buscamovimientoscajas" id="buscamovimientoscajas">
...
<?php if($_SESSION['acceso'] == "administradorG") { ?>
  ...
  <select name="codsucursal" id="codsucursal" class="form-control" onChange="CargaCajas(this.form.codsucursal.value);" required="" aria-required="true">
...
<?php } elseif($_SESSION['acceso'] == "administradorS") { ?>
...
<input type="hidden" name="codsucursal" id="codsucursal" value="<?php echo base64_encode($_SESSION["codsucursal"]); ?>"> 
    ...
    for($i = 0;$i < sizeof($caja);$i++) {
        ?>
  <option value="<?php echo base64_encode($caja[$i]['codcaja']); ?>"><?php echo $caja[$i]['nrocaja']." : ".$caja[$i]['nombrecaja']; ?></option>       
                      <?php } ?>
                  </select>
                              </div> 
                        </div>
...
<input type="hidden" name="codcaja" id="codcaja" value="<?php echo base64_encode($c[0]['codcaja']); ?>">
<input type="text" class="form-control" name="nrocaja" id="nrocaja" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $c[0]['nrocaja'].": ".$c[0]['nombrecaja']; ?>" readonly="readonly">
...
<button type="button" onClick="BuscaMovimientosCajas()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>			
                          </div>
						        ...
						        <div id="muestramovimientoscajas"></div>
						          </form>
           </div>
       </div>
</div>
