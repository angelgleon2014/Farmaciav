...
if (isset($_SESSION['acceso'])) {
    if ($_SESSION['acceso'] === "administradorG" || $_SESSION["acceso"] === "administradorS" || $_SESSION["acceso"] === "cajero" || $_SESSION["acceso"] === "bodega") {
        ...
        $simbolo = ($_SESSION['acceso'] === "administradorG" ? $conf[0]['simbolo'] : $_SESSION["simbolo"]);
...
<div class="content-page">
            <div class="content">
                ...
                <h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Ventas Diarias</h4>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Ventas Diarias</h3>
</div>
...
<?php
        ...
        if($reg == "") {
            ...
            for($i = 0;$i < sizeof($reg);$i++) {
                ...
                $TotalSinImpuestos += $reg[$i]['totalsinimpuestosve'];
                $TotalTarifano += $reg[$i]['tarifanove'];
                ...
                ?>
                                               <tr>
<td><?php echo $a++; ?></td>
<?php if ($_SESSION['acceso'] == "administradorG") { ?><td><abbr title="Sucursal: <?php echo $reg[$i]['razonsocial']; ?>"><?php echo $reg[$i]['rucsucursal']; ?></abbr></td><?php } ?>

<td><?php echo $reg[$i]['nrocaja']; ?></td>
<td><abbr title="TIPO DOCUMENTO: <?php echo $reg[$i]['tipodocumento']; ?>"><?php echo $reg[$i]['codventa']; ?></abbr></td>
...
<a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("TICKET") ?>" target="_black" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Ticket de Venta"><i class="fa fa-print"></i></a>
<?php } else { ?>
<a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("FACTURAVENTAS") ?>" target="_black" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Factura de Venta"><i class="fa fa-print"></i></a>
<?php } ?>

<a href="reportepdf?codventa=<?php echo base64_encode($reg[$i]['codventa']); ?>&tipo=<?php echo base64_encode("GUIAREMISION") ?>" target="_black" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Guia de Remisión"><i class="fa fa-print"></i></a>
...
<strong>Total Articulos : <?php echo $TotalArticulos; ?></strong><br>
<strong>Monto Descuento : <?php echo $simbolo.number_format($TotalDescuento, 2, '.', ','); ?></strong><br>
<strong>Monto Dcto Bonificación : <?php echo $simbolo.number_format($TotalBonificiacion, 2, '.', ','); ?></strong><br>
<strong>Monto Subtotal : <?php echo $simbolo.number_format($TotalSubtotal, 2, '.', ','); ?></strong><br>
<strong>Monto Total sin impuestos : <?php echo $simbolo.number_format($TotalSinImpuestos, 2, '.', ','); ?></strong><br>
<strong>Monto Tarifa 0% : <?php echo $simbolo.number_format($TotalTarifano, 2, '.', ','); ?></strong><br>
<strong>Monto Tarifa con % : <?php echo $simbolo.number_format($TotalTarifasi, 2, '.', ','); ?></strong><br>
<strong>Monto Total IGV : <?php echo $simbolo.number_format($Totaliva, 2, '.', ','); ?></strong><br>
<strong>Total General : <?php echo $simbolo.number_format($TotalPago, 2, '.', ','); ?></strong><br>
<!--<strong>Total Ganancias : <?php echo $simbolo.number_format($MargenBruto * 100, 2, '.', ','); ?></strong>-->
                                                 </div>
                                             </div>
                                        </div>
                                  </div>
