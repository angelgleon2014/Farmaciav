...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
              <h3 class="panel-title"><i class="fa fa-clipboard"></i> Factura de Pedido</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestrapedidosmodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Pedidos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Pedidos</li>
</ol>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Pedidos</h3>
</div>
                ...
                if(isset($_GET["mesage"])) {
                    switch($_GET["mesage"]) {
                        case 1:
                            ...
                            echo "<center><span class='fa fa-check-square-o'></span> EL PEDIDO DE PRODUCTO FUE ELIMINADO EXITOSAMENTE </center>";
                            echo "</div>";
                            break;
                        ...
                        case 2:
                            ...
                            echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<center><span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR PEDIDOS DE PRODUCTOS, NO ERES EL ADMINISTRADOR DEL SISTEMA</center>";
                            echo "</div>";
                            break;
    ...
    for($i = 0;$i < sizeof($reg);$i++) {
        ...
        ?>
                         ...
                         <td><?php echo date("d-m-Y h:i:s", strtotime($reg[$i]['fechapedido'])); ?></td>
											   <td>
<a href="#" class="btn btn-success btn-xs" onClick="VerPedido('<?php echo base64_encode($reg[$i]['codpedido']) ?>')" data-href="#" data-toggle="modal" data-target=".bs-example-modal-lg" data-placement="left" data-backdrop="static" data-keyboard="false" data-id="" rel="tooltip" data-original-title="" title="Ver Pedido"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Pedido" onClick="actualizarp('editpedidos?codpedido=<?php echo base64_encode($reg[$i]["codpedido"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Pedido" onClick="eliminarp('eliminar?<?php echo base64_encode('eliminar'); ?>&codpedido=<?php echo base64_encode($reg[$i]["codpedido"]) ?>&tipo=<?php echo base64_encode("PEDIDOS") ?>')"><i class="fa fa-trash-o"></i></a> 

<a href="reportepdf?codpedido=<?php echo base64_encode($reg[$i]['codpedido']); ?>&tipo=<?php echo base64_encode("PEDIDOS") ?>" target="_black" rel="noopener noreferrer" class="btn btn-info btn-xs" title="Imprimir" ><i class="fa fa-print"></i></a></td>
											   </tr>
											   <?php }
    } ?>
											   </tbody>
