...
<body onLoad="muestraReloj()" class="fixed-left">
    ...
    <div id="panel-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-content p-0 b-0">
                <div class="panel panel-color panel-primary">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">Datos de Productos</h3>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><span
                            ...
                            <div class="modal fade bs-example-modal-lgg" tabindex="-1" role="dialog"
                                        ...
                                        <div class="panel panel-color panel-primary">
                                            <div class="panel-heading">
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true"><img src="assets/images/close.png" /></button>
                                                <h3 class="panel-title"><i class="fa fa-align-justify"></i> Detalle y
                                                    Movimientos del Producto</h3>
                                            </div>
                                            <div class="panel-body">
                                    ...
                                    <div class="modal-content p-0 b-0">
                                        <div class="panel panel-color panel-primary">
                                            <div class="panel-heading">
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true"><img src="assets/images/close.png" /></button>
                                                <h3 class="panel-title"><i class="fa fa-picture-o"></i> Foto del
                                                    Producto</h3>
                                            </div>
                                            <div class="panel-body">
                                    ...
                                    <div class="modal-content p-0 b-0">
                                        <div class="panel panel-color panel-primary">
                                            <div class="panel-heading">
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true"><img src="assets/images/close.png" /></button>
                                                <h3 class="panel-title"><i class="fa fa-save"></i> Registro de ProductosSSSSSSSSSSSSSS
                                                </h3>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <div id="codigoproducto"><input type="text"
                                                                        class="form-control" name="codproducto"
                                                                        id="codproducto"
                                                                        onKeyUp="this.value=this.value.toUpperCase();"
                                                                        autocomplete="off"
                                                                        placeholder="Ingrese Código de Producto" value="<?php $prod = new Login();
        echo $p = $prod->CodigoProducto(); ?>" tabindex="1" required="" aria-required="true"></div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="principioactivo" id="principioactivo"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Principio Activo" tabindex="3"
                                                                    aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Presentación: <span
                                                                        class="symbol required"></span></label>
                                                                <select name="codpresentacion" id="codpresentacion"
        ...
        for($i = 0;$i < sizeof($pre);$i++) {
            ?>
                                                                                <option
                                                                                    value="<?php echo $pre[$i]['codpresentacion'] ?>">
                                                                                    <?php echo $pre[$i]['nompresentacion'] ?>
                                                                                </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <select name="codmedida" id="codmedida" tabindex="6"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <select name="codlaboratorio" id="codlaboratorio"
        ...
        for($i = 0;$i < sizeof($lab);$i++) {
            ?>
                                                                            <option
                                                                                value="<?php echo $lab[$i]['codlaboratorio'] ?>">
                                                                                <?php echo $lab[$i]['nomlaboratorio'] ?>
                                                                            </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <select name="codproveedor" id="codproveedor"
        ...
        for($i = 0;$i < sizeof($proveedor);$i++) {
            ?>
                                                                            <option
                                                                                value="<?php echo $proveedor[$i]['codproveedor'] ?>">
                                                                                <?php echo $proveedor[$i]['nomproveedor'] ?>
                                                                            </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    name="loteproducto" id="loteproducto"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    ...
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Precio de Compra" value="0.00"
                                                                    tabindex="10">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Precio por Caja (PVP):
                                                                </label>
                                                                <input class="form-control calculounidad" type="text"
                                                                    name="precioventacaja" id="precioventacaja"
                                                                    onKeyPress="EvaluateText('%f', this);"
                                                                    onBlur="this.value = NumberFormat(this.value, '2', '.', '')"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Precio de Venta (Cajas)"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Precio por Unidad (PVP):
                                                                </label>
                                                                <input class="form-control" type="text"
                                                                    name="precioventaunidad" id="precioventaunidad"
                                                                    onKeyPress="EvaluateText('%f', this);"
                                                                    onBlur="this.value = NumberFormat(this.value, '2', '.', '')"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Precio de Venta (Unid.)"
                                                                    tabindex="12" value="0.00" readonly="readonly">
                                                                <i class="fa fa-money form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input class="form-control calculostock" type="text"
                                                                    name="stockcajas" id="stockcajas"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Stock por Cajas" value="0"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Unidades por Cajas:
                                                                </label>
                                                                <input class="form-control calculounidad calculostock"
                                                                    type="text" name="unidades" id="unidades"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Unidades por Cajas"
                                                                    tabindex="14" value="0" aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Stock por Unidad (Sin
                                                                    Cajas): </label>
                                                                <input type="text" class="form-control calculostock"
                                                                    name="stockunidad" id="stockunidad"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Stock por Unidad" tabindex="15"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="stocktotal" id="stocktotal"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off" placeholder="Ingrese Stock Total"
                                                                    tabindex="16" value="0" readonly="readonly">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Stock Minimo de Producto"
                                                                    tabindex="17" aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <select name="ivaproducto" id="ivaproducto"
                                                                    tabindex="18" class="form-control"
                                                                    aria-required="true">
                                                                    <option value="">SELECCIONE</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    name="descproducto" id="descproducto"
                                                                    onKeyPress="EvaluateText('%f', this);"
                                                                    onBlur="this.value = NumberFormat(this.value, '2', '.', '')"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Descuento de Producto"
                                                                    tabindex="19" aria-required="true">
                                                                <i class="fa fa-money form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control calendario"
                                                                    name="fechaelaboracion" id="fechaelaboracion"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Fecha de Elaboración"
                                                                    tabindex="20" aria-required="true">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control calendario"
                                                                    ...
                                                                    tabindex="21" aria-required="true">
                                                                <i class="fa fa-calendar form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="codigobarra" id="codigobarra"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Ubicación en Estante:
                                                                </label>
                                                                <input class="form-control" type="text" name="ubicacion"
                                                                    id="ubicacion"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese ubicacion en Estanteria"
                                                                    tabindex="23" aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Status de Producto:
                                                                </label>
                                                                <select name="statusp" id="statusp" class="form-control"
                                                                    tabindex="24" aria-required="true">
                                                                    <option value="">SELECCIONE</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="hidden" name="codsucursal" id="codsucursal"
                                                                    ...
                                                                    type="text" class="form-control" name="sucursal"
                                                                    id="sucursal"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Nombre de Sucursal"
                                                                    value="<?php echo $_SESSION["razonsocial"]; ?>"
                                                                    tabindex="25" readonly="readonly">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <select name="codsucursal" id="codsucursal"
                                                            ...
                                                            for($i = 0;$i < sizeof($sucursal);$i++) {
                                                                ?>
                                                                            <option
                                                                                value="<?php echo $sucursal[$i]['codsucursal'] ?>">
                                                                                <?php echo $sucursal[$i]['razonsocial'] ?>
                                                                            </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
        ...
        ?>
                                                                ...
                                                                <div>
                                                                    <span class="btn btn-default btn-file">
                                                                        ...
                                                                        <input type="file" size="10"
                                                                            ...
                                                                            data-rel="tooltip"
                                                                            placeholder="Suba su Fotografia"
                                                                            name="imagen" id="imagen" tabindex="26" />
                                                                    </span>
                                                                    <a href="#" class="btn btn-danger fileinput-exists"
                                                                        data-dismiss="fileinput"><i
                                                                            class="fa fa-times-circle"></i>
                                                                        Remover</a><small>
                                                                        <p>Para Subir la Foto del Producto debe tener en
                                                                            cuenta lo siguiente:<br> * La Imagen debe
                                                                            ser extension.jpg<br> * La imagen no debe
                                                                            ser mayor de 50 KB</p>
                                                                    </small> </div>
                                                            </div>
                                                        </div>
                                                    </div><br>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" name="btn-submit" id="btn-submit"
                                                        ...
                                                        Guardar</button>
                                                    <button class="btn btn-danger" type="reset" class="close"
                                                        data-dismiss="modal" aria-hidden="true"><i
                                                            class="fa fa-trash-o"></i> Cerrar</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-content p-0 b-0">
                                        <div class="panel panel-color panel-primary">
                                            <div class="panel-heading">
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-hidden="true"><img src="assets/images/close.png" /></button>
                                                <h3 class="panel-title"><i class="fa fa-edit"></i> Actualizar Productos
                                                </h3>
                                            </div>
                                            <form class="form" method="post" action="#" name="updateproducto"
                                                id="updateproducto" enctype="multipart/form-data">
                                                <div class="panel-body">
                                                    <div id="update">
                                                        <!-- error will be shown here ! -->
                                                    </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Descripción de Producto"
                                                                    tabindex="4" required="" aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
        ...
        for($i = 0;$i < sizeof($proveedor);$i++) {
            ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Precio de Compra: <span
                                                                        class="symbol required"></span></label>
                                                                <input class="form-control" type="text"
                                                                    name="preciocompra" id="preciocompra"
                                                                    onKeyPress="EvaluateText('%f', this);"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input class="form-control calculounidad2" type="text"
                                                                    name="precioventacaja" id="precioventacaja2"
                                                                    onKeyPress="EvaluateText('%f', this);"
                                                                    onBlur="this.value = NumberFormat(this.value, '2', '.', '')"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Precio de Venta (Cajas)"
                                                                    tabindex="11" required="" aria-required="true">
                                                                <i class="fa fa-money form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Precio por Unidad (PVP):
                                                                    <span class="symbol required"></span></label>
                                                                <input class="form-control" type="text"
                                                                    name="precioventaunidad" id="precioventaunidad2"
                                                                    onKeyPress="EvaluateText('%f', this);"
                                                                    onBlur="this.value = NumberFormat(this.value, '2', '.', '')"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Stock por Cajas: <span
                                                                        class="symbol required"></span></label>
                                                                <input class="form-control calculostock2" type="text"
                                                                    name="stockcajas" id="stockcajas2"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Stock por Cajas" value="0"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Unidades por Cajas: <span
                                                                        class="symbol required"></span></label>
                                                                <input class="form-control calculounidad2 calculostock2"
                                                                    type="text" name="unidades" id="unidades2"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Unidades por Cajas"
                                                                    tabindex="14" value="0" required=""
                                                                    aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Stock por Unidad (Sin
                                                                    Cajas): <span
                                                                        class="symbol required"></span></label>
                                                                <input type="text" class="form-control calculostock"
                                                                    name="stockunidad" id="stockunidad2"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Stock por Unidad" tabindex="15"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Stock Total: </label>
                                                                <input type="text" class="form-control"
                                                                    name="stocktotal" id="stocktotal2"
                                                                    onKeyUp="this.value=this.value.toUpperCase();"
                                                                    autocomplete="off" placeholder="Ingrese Stock Total"
                                                                    tabindex="16" value="0" readonly="readonly">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Stock Minimo de Producto"
                                                                    tabindex="17" required="" aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">IGV de Producto: <span
                                                                        class="symbol required"></span></label>
                                                                <select name="ivaproducto" id="ivaproducto"
                                                                    tabindex="18" class="form-control" required=""
                                                                    aria-required="true">
                                                                    <option value="">SELECCIONE</option>
                                                                    <option value="SI">SI</option>
                                                                    <option value="NO">NO</option>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input class="form-control" type="text"
                                                                    ...
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Descuento de Producto"
                                                                    tabindex="19" required="" aria-required="true">
                                                                <i class="fa fa-money form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control calendario"
                                                                    ...
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Fecha de Elaboración"
                                                                    tabindex="20" required="" aria-required="true">
                                                                <i class="fa fa-calendar form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input type="text" class="form-control calendario"
                                                                    ...
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese Fecha de Expiración"
                                                                    tabindex="21" required="" aria-required="true">
                                                                <i class="fa fa-calendar form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                ...
                                                                <input class="form-control" type="text" name="ubicacion"
                                                                    ...
                                                                    autocomplete="off"
                                                                    placeholder="Ingrese ubicacion en Estanteria"
                                                                    tabindex="23" required="" aria-required="true">
                                                                <i class="fa fa-pencil form-control-feedback"></i>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Status de Producto: <span
                                                                        class="symbol required"></span></label>
                                                                <select name="statusp" id="statusp" class="form-control"
                                                                    tabindex="24" required="" aria-required="true">
                                                                    <option value="">SELECCIONE</option>
                                                                    <option value="0">ACTIVO</option>
                                                                    <option value="1">INACTIVO</option>
                                                                </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group has-feedback">
                                                                <label class="control-label">Sucursal: <span
                                                                        class="symbol required"></span></label>
                                                                <select name="codsucursal" id="codsucursal"
                                                                    tabindex="25" class="form-control" required=""
                                                                    aria-required="true">
                                                                    <option value="">SELECCIONE</option>
                                                                    <?php
                                                                            $sucursal = new Login();
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="fa fa-tasks"></i> Productos<span class="pull-right">
                               
                                    <?php if ($_SESSION['acceso'] == "administradorG" || $_SESSION['acceso'] == "administradorS") { ?>

                                        <a class="btn btn-default waves-effect waves-light" data-toggle="modal"
                                            data-target="#myModal" data-backdrop="static" data-keyboard="false"
                                            data-placement="left" title="" data-original-title="Nuevo Producto"><i
                                            ...
                                            <table id="datatable-responsive"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th>PVP Caja</th>
                                                        <th>Exist</th>
                                                        <?php if ($_SESSION['acceso'] == "administradorG") { ?><th>
                                                            Sucursal</th><?php } ?>
                                                        <th>Acciones</th>
                                                    </tr>
                                                </thead>
