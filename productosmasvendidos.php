...
if (isset($_SESSION['acceso'])) {
    if ($_SESSION['acceso'] == "administradorG" || $_SESSION["acceso"] == "administradorS" || $_SESSION["acceso"] == "cajero" || $_SESSION["acceso"] == "bodega") {
        ...
        $con = new Login();
        $con = $con->ContarRegistros(); // Asegúrate de que ContarRegistros sigue siendo relevante aquí
                                        // o crea un método específico para conteos si es necesario.
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-star"></i> Productos Más Vendidos</h4>
...
<div class="row">
<div class="col-sm-12">
     <form class="form" method="post" action="#" name="buscamasvendidos" id="buscamasvendidos">
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-star"></i> Top Productos Más Vendidos</h3></div>
...
<?php if($_SESSION['acceso'] == "administradorG") { ?>
   ...
   <select name="codsucursal" id="codsucursal" class="form-control" required="" aria-required="true">
        ...
        for ($i = 0; $i < sizeof($suc); $i++) {
            ...
            echo "<option value='" . base64_encode($suc[$i]['codsucursal']) . "' $selected>" . $suc[$i]['razonsocial'] . "</option>";
        }
        ?>
                              </select>
                                  </div> 
...
<?php } ?>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group has-feedback">
                <label class="control-label">Mostrar Top: <span class="symbol required"></span></label>
                <select name="top_n" id="top_n" class="form-control" required="" aria-required="true">
                    <option value="">Seleccione</option>
                    <?php for ($i = 1; $i <= 30; $i++) { ?>
...
<button type="button" onClick="BuscaMasVendidos()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>       
                           </div>
