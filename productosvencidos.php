...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Productos Vencidos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li><a href="productos">Control</a></li>
<li class="active">Productos Vencidos</li>
</ol>
...
<div class="row">
<div class="col-sm-12">
    <form class="form" method="post"  action="#" name="buscaproductosvencidos" id="buscaproductosvencidos">
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Productos Vencidos</h3></div>
...
<option value="<?php echo base64_encode($suc[$i]['codsucursal']); ?>"><?php echo $suc[$i]['razonsocial']; ?></option>       
        ...
        <div class="col-md-6"> 
                              <div class="form-group has-feedback"> 
<label class="control-label">Seleccione Tipo Búsqueda: <span class="symbol required"></span></label>
  <select name="tiempovence" id="tiempovence" class="form-control" required="" aria-required="true">
                  <option value="">SELECCIONE</option>
                  <option value="0">PRODUCTOS VENCIDOS</option>
                  <option value="15">15 DIAS POR VENCER</option>
                  <option value="30">1 MESES POR VENCER</option>
                  <option value="60">2 MESES POR VENCER</option>
                  <option value="90">3 MESES POR VENCER</option>
                  </select>
                              </div> 
                        </div>
                    </div><br> 
...
<input type="hidden" name="codsucursal" id="codsucursal" value="<?php echo base64_encode($_SESSION["codsucursal"]); ?>">
...
<label class="control-label">Seleccione Tipo Búsqueda: <span class="symbol required"></span></label>
  <select name="tiempovence" id="tiempovence" class="form-control" required="" aria-required="true">
                  <option value="">SELECCIONE</option>
                  <option value="0">PRODUCTOS VENCIDOS</option>
                  <option value="5">5 DIAS POR VENCER</option>
                  <option value="15">15 DIAS POR VENCER</option>
                  <option value="30">1 MESES POR VENCER</option>
                  <option value="60">2 MESES POR VENCER</option>
                  <option value="90">3 MESES POR VENCER</option>
...
<button type="button" onClick="BuscaProductoVencidos()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>      
                          </div>
                            ...
                            <div id="muestraproductosvencidos"></div>
                              </form>
                   </div>
               </div>
        </div>
