...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Productos Vendidos</h4>
...
<div class="row">
<div class="col-sm-12">
    <form class="form" method="post"  action="#" name="buscaproductosvendidos" id="buscaproductosvendidos">
...
<?php } ?>
<div class="panel-heading"><h3 class="panel-title"><i class="fa fa-tasks"></i> Productos Vendidos</h3></div>
...
<button type="button" onClick="BuscaProductoVendidos()" class="btn btn-primary"><span class="fa fa-search"></span> Realizar Búsqueda</button>      
                          </div>
