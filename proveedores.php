                ...
                if(isset($_GET["mesage"])) {
                    switch($_GET["mesage"]) {
                        case 1:
                            ...
                            echo "<span class='fa fa-check-square-o'></span> EL PROVEDOR FUE ELIMINADO EXITOSAMENTE</center>";
                            echo "</div>";
                            break;
                        ...
                        case 2:
                            ...
                            echo "<center><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<span class='fa fa-info-circle'></span> ESTE PROVEEDOR NO PUEDE SER ELIMINADO, TIENE VENTAS ASOCIADAS ACTUALMENTE</center>";
                            echo "</div>";
                            break;
                        ...
                        case 3:
                            ...
                            echo "<center><span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR PROVEEDORES, NO ERES EL ADMINISTRADOR DEL SISTEMA </center>";
                            echo "</div>";
                            break;
