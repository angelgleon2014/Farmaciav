...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
                                                            <h3 class="panel-title">Datos de Sucursal</h3> 
                                                        </div> 
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Sucursales</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Sucursales</li>
</ol>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Sucursales<span class="pull-right">
...
<li><a href="forsucursal" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nueva Sucursal"><i class="fa fa-plus"></i> Nuevo</a></li>
<li><a href="reportepdf?tipo=<?php echo base64_encode("SUCURSALES") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Pdf)"><i class="fa fa-file-pdf-o"></i> Listado (Pdf)</a></li>
<li><a href="reporteexcel?tipo=<?php echo base64_encode("SUCURSALES") ?>" data-toggle="tooltip" data-placement="left" title="" data-original-title="Listado (Excel)"><i class="fa fa-file-excel-o"></i> Listado (Excel)</a></li>
            </ul>
</div>
</span></h3>
</div>
...
if($reg == "") {
 ...
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Sucursal" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerSucursal('<?php echo base64_encode($reg[$i]["codsucursal"]); ?>')"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Sucursal" onClick="actualizar('forsucursal?codsucursal=<?php echo base64_encode($reg[$i]["codsucursal"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Sucursal" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codsucursal=<?php echo base64_encode($reg[$i]["codsucursal"]) ?>&tipo=<?php echo base64_encode("SUCURSALES") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php }
    } ?>
											   </tbody>
