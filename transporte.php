...
<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button> 
    <h3 class="panel-title"><i class="fa fa-align-justify"></i> Datos de Transporte</h3> 
                                                        </div> 
                                                        <div class="panel-body"> 
                                                         <div id="muestrachofermodal"></div>
                                                        </div>
...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Transportes</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Transportes</li>
</ol>
...
<?php } ?>
<div class="panel-heading">
<h3 class="panel-title"><i class="fa fa-tasks"></i> Transportes<span class="pull-right"><a href="fortransporte" class="btn btn-default waves-effect waves-light" data-toggle="tooltip" data-placement="left" title="" data-original-title="Nuevo Transporte"><span class="fa fa-plus"></span> Nuevo</a></span></h3>
</div>
                ...
                if(isset($_GET["mesage"])) {
                    switch($_GET["mesage"]) {
                        case 1:
                            ...
                            echo "<center><span class='fa fa-check-square-o'></span> EL TRANSPORTE DE GUIA FUE ELIMINADO EXITOSAMENTE </center>";
                            echo "</div>";
                            break;
                        ...
                        case 2:
                            ...
                            echo "<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>";
                            echo "<center><span class='fa fa-info-circle'></span> USTED NO TIENE ACCESO PARA ELIMINAR TRANSPORTE DE GUIAS, NO ERES EL ADMINISTRADOR DEL SISTEMA </center>";
                            echo "</div>";
                            break;
...
if($reg == "") {
    ...
    for($i = 0;$i < sizeof($reg);$i++) {
        ?>
											   ...
											   <td><?php echo $reg[$i]['rucchofer']; ?></td>
											   <td><?php echo $reg[$i]['nomchofer']; ?></td>
											   <td><?php echo $reg[$i]['tlfchofer']; ?></td>
											   <td><?php echo $reg[$i]['placavehiculo']; ?></td>
                         <td><?php echo $status = ($reg[$i]['statuschofer'] == '0' ? "<span class='label label-success'><i class='fa fa-check'></i> ACTIVO</span>" : "<span class='label label-warning'><i class='fa fa-times'></i> INACTIVO</span>"); ?></td>
											   <td>
 
 <a href="#" class="btn btn-success btn-xs" data-placement="left" title="Ver Chofer" data-original-title="" data-href="#" data-toggle="modal" data-target="#panel-modal" data-backdrop="static" data-keyboard="false" onClick="VerChofer('<?php echo base64_encode($reg[$i]["codchofer"]); ?>')"><i class="fa fa-search-plus"></i></a>
								  
<a href="#" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Editar Chofer" onClick="actualizar('fortransporte?codchofer=<?php echo base64_encode($reg[$i]["codchofer"]) ?>')"><i class="fa fa-pencil"></i></a>
                                 
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Chofer" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codchofer=<?php echo base64_encode($reg[$i]["codchofer"]) ?>&tipo=<?php echo base64_encode("CHOFER") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php }
    } ?>
											   </tbody>
