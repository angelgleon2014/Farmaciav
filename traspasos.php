...
<div class="row">
<div class="col-sm-12">
<div class="page-header-title"><h4 class="pull-left page-title"><i class="fa fa-tasks"></i> Control de Traspasos</h4>
<ol class="breadcrumb pull-right"><li><a href="panel">Inicio</a></li>
<li class="active">Control de Traspasos</li>
</ol>
...
<h3 class="panel-title"><i class="fa fa-tasks"></i> Control de Traspasos</h3>
</div>
...
<div class="col-sm-12">
 ...
 <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;" width="100%" cellspacing="0">
												 ...
												 <tr role="row">
												 <th>N°</th>
<?php if ($_SESSION['acceso'] == "administradorG") { ?><th>Emisión</th><?php } ?>
                         <th>Recepción</th>
												 <th>Código</th>
												 <th>Producto</th>
												 <th>Cantidad</th>
...
<?php
        ...
        if($envio == "") {
            ...
            $a = 1;
            for($i = 0;$i < sizeof($envio);$i++) {

                ?>
                                <tr role="row" class="odd">
											   <td class="sorting_1" tabindex="0"><?php echo $a++; ?></td>
<?php if ($_SESSION['acceso'] == "administradorG") { ?><td><?php echo $envio[$i]['enviado']; ?></td><?php } ?>
                         <td><?php echo $envio[$i]['recibido']; ?></td>
                         <td><?php echo $envio[$i]['codproductot']; ?></td>
<td><?php echo $envio[$i]['producto']." - ".$envio[$i]['nommedida']." ".$envio[$i]['nompresentacion']; ?></td>
											   <td><?php echo $envio[$i]['cantenvio']; ?></td>
											   <td><?php echo date("d-m-Y h:i:s", strtotime($envio[$i]['fechatraspaso'])); ?></td>
											   </tr>
											   <?php  }
        } ?>
											   </tbody>
