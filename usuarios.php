...
<a href="#" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="left" title="" data-original-title="Eliminar Usuario" onClick="eliminar('eliminar?<?php echo base64_encode('eliminar'); ?>&codigo=<?php echo base64_encode($reg[$i]["codigo"]) ?>&tipo=<?php echo base64_encode("USUARIOS") ?>')"><i class="fa fa-trash-o"></i></a> </td>
											   </tr>
											   <?php }
    } ?>
											   </tbody>
